  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function setupColumnReorder() {
      ...
      $headers.sortable({
        ...
        start: function (e, ui) {
          ui.placeholder.width(ui.helper.width() - headerColumnWidthDiff);
    ...
    function measureCellPaddingAndBorder() {
	  ...
	  // jquery 1.8 changed .width to read the true inner element width if box-sizing is set to border-box, and introduced a setter for .width
	  // so for equivalent functionality, prior to 1.8 use .width, and after use .width
